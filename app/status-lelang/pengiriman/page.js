    ...
    <main className="page-container" style={{ maxWidth: '1000px', margin: '0 auto', paddingTop: '3rem' }}>
      <div className="checkout-card" style={{ background: 'white', border: '1px solid #E5E7EB', borderRadius: '12px', padding: '2rem', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem', paddingBottom: '2rem', borderBottom: '1px solid #E5E7EB' }}>
          ...
          <div><a href="#" style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem' }}>Ubah</a></div>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          <div style={{ width: '300px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
              ...
              <span style={{ fontWeight: 800, fontSize: '1.25rem' }}>Rp 25.565.000</span>
            </div>
            <Link href="/status-lelang/pembayaran" className="btn-primary-full" style={{ textDecoration: 'none', display: 'block', textAlign: 'center', borderRadius: '8px', padding: '0.85rem', fontWeight: 700 }}>Konfirmasi Pengiriman</Link>
          </div>
        </div>
      </div>
    </main>
